...
| STT | Chuỗi phím đã gõ | Kết quả mong đợi | Kết quả thực tế | Ứng dụng/Chú thích |
|-----|------------------|------------------|-----------------|--------------------|
| 1 | `gooox` | `gõ` | `goxxx` | Notepad |
| 2 | | | | |
| 3 | | | | |
...
- **STT:** Số thứ tự lỗi.
- **Chuỗi phím đã gõ:** Gõ đúng từng phím bạn đã nhấn, bao gồm cả phím dấu.
