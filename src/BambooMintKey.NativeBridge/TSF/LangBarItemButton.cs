...
public static unsafe class LangBarItemButton
{
    ...
    /// Tích hợp và đồng bộ 100% với logic HotkeyFormatter của Core.
    /// </summary>
    public static string GetToggleHotkeyDisplayText()
    {
        uint vKey = SharedMemoryManager.HotkeyVKey;
        uint mods = SharedMemoryManager.HotkeyModifiers;
        return HotkeyFormatter.getToggleMenuLabel(vKey, mods);
    }
